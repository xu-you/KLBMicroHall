            ...
            >
                ...
                >
                    ...
                    <template #icon="props">
                        <img
                            :src="
                                props.ButtonTabActive
                                    ? item.ButtonTabActive
                                    : item.normal
                            "
                        />
                    </template>
...
export default class BankManage extends Vue {
    ...
    private ButtonTabActive: number = 1;
    private created() {
    ...
    private tabbars: any = [
        {
            ...
            normal: require('../../../../img/icon_tabber_40首页_n.png'),
        },
        {
            name: 'myInvestment',
            title: '我的投资',
            ButtonTabActive: require('../../../../img/icon_tabber_40我的_n.png'),
            normal: require('../../../../img/icon_tabber_40我的_h.png'),
        },
    ];
    ...
    private mounted() {
        ...
        this.tabActive = sessionStorage.getItem('activeNumber') || '';
