...
<template>
    <div
        ...
        @touchend="end"
    >
        <img class="title-icon" src="../../../img/免费领红包.png" alt=" " />
    </div>
</template>
...
export default {
    ...
    methods: {
        ...
        // 实现移动端拖拽
        down() {
            let default_drag_comp = document.querySelector(
                '#default_drag_comp'
            );
            this.flags = true;
            let touch;
            ...
            this.maxW =
                document.body.clientWidth - default_drag_comp.offsetWidth;
            this.maxH =
                document.body.clientHeight - default_drag_comp.offsetHeight;
